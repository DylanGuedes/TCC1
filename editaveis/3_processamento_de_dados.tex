...
pontual e simples, que se sustenta em um menor conjunto de ferramentas e
...
Logo, cada uma das arquiteturas apresenta vantagens, mas o contexto é
determinante na escolha da arquitetura correta para um dado problema. A
Arquitetura Kappa, sem a reprodução dos dados, permite somente o uso de
...
tarefa sem maiores problemas. Ou seja, pela Lambda suportar algoritmos e tarefas
